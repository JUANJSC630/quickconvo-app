  ...
  const handleFileChange = (event: React.ChangeEvent<HTMLInputElement>) => {
    if (event.target.files && event.target.files[0]) {
      ...
      if (fileType !== "text/plain") {
        setError("Please upload a valid TXT document.");
        setFile(null);
      } else {
  ...
  return (
    <div>
      ...
      <div className="container mx-auto p-6">
        <motion.h1
          className="text-4xl sm:text-5xl md:text-6xl font-bold text-center mb-6 bg-clip-text text-transparent bg-gradient-to-r from-gray-500 to-zinc-500"
        ...
        >
          Transform your TXT documents to PDF format quickly and easily.
        </motion.p>
        ...
        <div className="bg-white p-8 rounded-lg shadow-lg max-w-2xl mx-auto">
          <div className="space-y-6">
            <div className="flex items-center justify-center w-full">
              ...
              >
                <div className="flex flex-col items-center justify-center pt-5 pb-6">
                  ...
                  <p className="text-xs text-gray-500">TXT document (TXT)</p>
                </div>
                <Input
                  id="dropzone-file"
                  type="file"
            ...
            <Button
              ...
              className="w-full bg-gradient-to-r from-gray-400 to-zinc-500 hover:from-gray-600 hover:to-zinc-600 text-white"
            >
            ...
            <AnimatePresence>
              {pdfUrl && file && (
                ...
                >
                  ...
                  <Button
                    asChild
                    className="w-full bg-gradient-to-r from-zinc-600 to-gray-400 hover:from-gray-600 hover:to-zinc-600 text-white"
                  >
                    <a
                      href={pdfUrl}
