  ...
  const handleFileChange = (event: React.ChangeEvent<HTMLInputElement>) => {
    if (event.target.files && event.target.files[0]) {
      ...
      if (
        ...
        setError("Please upload a valid Excel document (PPT or PPTX).");
        setFile(null);
      } else {
  ...
  return (
    <div>
      ...
      <div className="container mx-auto p-6">
        <motion.h1
          className="text-4xl sm:text-5xl md:text-6xl font-bold text-center mb-6 bg-clip-text text-transparent bg-gradient-to-r from-orange-600 to-amber-500"
            ...
            <AnimatePresence>
              {pdfUrl && file && (
                ...
                >
                  ...
                  <Button
                    asChild
                    className="w-full bg-gradient-to-r from-amber-600 to-orange-500 hover:from-orange-700 hover:to-amber-600 text-white"
                  >
                    <a
                      href={pdfUrl}
